...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // Adds a button for starting the visualization
        //  and one to pause the visualization. 
        ...
        controls.getChildren().addAll(
                ...
                jumpToLabel, timesTableNumBox, numPointsBox, jumpToButton, startButton, pauseButton);
        // Create the canvas
        ...
        class MyAnimationTimer extends AnimationTimer {
            ...
            /**
             * Check if desired amount of seconds have elapsed since last
             * update.
             */
            @Override
        ...
        // Adds the on click events and corresponding implementations
